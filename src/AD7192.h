...
#define AD7192_SPIx VSPI
// #define AD7192_SPIx_CLK_ENABLE() __HAL_RCC_SPI1_CLK_ENABLE()
// #define AD7192_GPIO_CLK_ENABLE() __HAL_RCC_GPIOA_CLK_ENABLE()
#define SPI_CS 15
#define SPI_SCLK 14
#define SPI_DOUT 12 // MOSI
#define SPI_DIN 13  // MISO
#define AD7192_CS_Pin 5
#define AD7192_SCK_Pin 18
#define AD7192_MISO_Pin 19 // DOUT
#define AD7192_MOSI_Pin 23 // DIN

#define AD7192_SCLK_H digitalWrite(AD7192_SCK_Pin, HIGH)
#define AD7192_SCLK_L digitalWrite(AD7192_SCK_Pin, LOW)

#define AD7192_CS_ENABLE() digitalWrite(AD7192_CS_Pin, LOW)
#define AD7192_CS_DISABLE() digitalWrite(AD7192_CS_Pin, HIGH)
